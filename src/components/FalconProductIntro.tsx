  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-24 space-y-28">
        ...
        >
          <h2 className="text-sm tracking-[0.3em] font-extrabold text-sky-400">
            Falcon Series
          </h2>
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            A new class of interceptor drones engineered for{" "}
            <span className="text-sky-400 font-semibold">
              autonomous air defense
            </span>
            . Powered by the{" "}
            <span className="font-semibold text-white">MatriX OS Suite</span>,
            Falcon drones combine AI-driven tracking and real-time decision
            systems to intercept threats with speed, precision, and
            intelligence.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="md:w-1/2 space-y-5">
            ...
            <p className="text-gray-300 leading-relaxed">
              Compact, stealth-optimized, and fully autonomous — the Falcon
              Interceptor neutralizes airborne intrusions with precision. Using
              multi-sensor fusion (radar, optical, and infrared), it reacts and
            ...
            <p className="text-gray-400">
              ...
              , it operates in coordinated missions across aerial, naval, and
        ...
        >
          {[
            {
              title: "High-Speed Interception",
              desc: "Cruise at 200 km/h with advanced stability controls.",
              icon: <Gauge />,
            },
            {
              title: "Autonomous Target Tracking",
              desc: "AI-guided pursuit and lock-on, even without GPS.",
              icon: <Crosshair />,
            },
            {
              title: "Stealth Frame",
              desc: "3 kg radar-absorbent composite for silent mobility.",
              icon: <AirVent />,
            },
            {
              title: "AI-Guided Precision",
              desc: "MatriX OS neural core for sub-second decisions.",
              icon: <Cpu />,
            },
            {
              title: "Rapid Launch",
              desc: "Deployment-ready in under 5 seconds.",
              icon: <Rocket />,
            },
            {
              title: "Swarm Coordination",
              desc: "Synchronizes with other Falcons for multi-threat response.",
              icon: <Radar />,
            },
