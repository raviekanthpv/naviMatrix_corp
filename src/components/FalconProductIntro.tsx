  ...
  <div className="max-w-7xl mx-auto px-6 py-24 space-y-28">
    ...
    >
      <img
        src={falcon}
        alt="Falcon Drone"
        className="rounded-2xl w-full w-[100px] object-cover shadow-[0_0_80px_rgba(56,189,248,0.25)]"
      />
    ...
    >
      <img
        ...
        className="w-full w-[90px] rounded-2xl shadow-[0_0_50px_rgba(56,189,248,0.15)]"
      />
