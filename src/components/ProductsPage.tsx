...
export default function ProductsPage() {
  const products = [
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/3862618/pexels-photo-3862618.jpeg?auto=compress&cs=tinysrgb&w=800",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Each drone system is engineered for specific applications,
              combining cutting-edge technology with field-proven reliability
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-300">
                  4K/8K cameras with thermal and multispectral sensors
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-300">
                  Extended flight times with intelligent power management
                </p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300">
                  Military-grade encryption and mesh networking
                </p>
              </div>
            </div>
          </div>
