...
export default function Navbar() {
  ...
  // ✅ Declare this OUTSIDE the effect
  const lastYRef = useRef<number>(window.scrollY);
  useEffect(() => {
    const scrollContainer = document.body; // 👈 the actual scroll element
    const handleScroll = () => {
    ...
    console.log("%cNavbar scroll listener attached ✅ (body)", "color:#4ade80");
    ...
    if (layout === "bigLayout") {
      return (
        <div className="fixed left-0 right-0 z-[45] mt-0 animate-slideDown overflow-hidden top-[64px]">
          <div className="w-screen backdrop-blur-xl border-t border-white/10 bg-gradient-to-b from-black/90 via-black/95 to-black shadow-[0_40px_120px_-20px_rgba(255,255,255,0.25)]">
            <div
                ...
                >
                  <div className="relative w-full h-full">
                    ...
                    <div className="relative z-10 h-full w-full p-8 flex flex-col justify-end">
                      <div className="flex items-center gap-2 text-text-light/90 group-hover:text-white transition">
                        {s.icon}
