...
import { Users, Award, Globe, Lightbulb, ArrowRight } from 'lucide-react';
      ...
      <div className="bg-slate-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Founded by aerospace industry veterans, NaviMatriX is revolutionizing autonomous flight 
            with military-grade precision and commercial scalability.
          </p>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                To democratize advanced aerial intelligence by creating the world's most reliable, 
                intelligent, and secure autonomous drone systems for military, industrial, and 
                commercial applications.
              </p>
              <p className="text-lg text-gray-600">
                We believe that autonomous flight technology should be accessible to organizations 
                worldwide, enabling them to achieve their objectives with unprecedented efficiency 
                and safety.
              </p>
            </div>
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                To become the global leader in autonomous drone systems, setting the standard for 
                reliability, intelligence, and security in unmanned aerial vehicles across all 
                industries and applications.
              </p>
              <p className="text-lg text-gray-600">
                We envision a world where intelligent drones seamlessly integrate into daily 
                operations, making the impossible possible and the dangerous safe.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our leadership combines decades of experience from leading aerospace, defense, 
          ...
          <div className="grid gap-8 mb-16 md:grid-cols-[repeat(auto-fit,minmax(250px,1fr))] justify-items-center">
            {team.map((member, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-lg text-center">
                ...
                <div className="text-sky-600 font-semibold mb-4">{member.position}</div>
      ...
      <div className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From startup to global leader, our milestones reflect our commitment to innovation 
              and excellence in autonomous flight technology.
            </p>
          </div>
      ...
      <div className="bg-slate-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Whether you're looking for career opportunities, partnerships, or investment possibilities, 
